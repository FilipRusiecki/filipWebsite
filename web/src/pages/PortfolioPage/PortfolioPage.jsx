  ...
  return (
    <>
      ...
      <div className="dark bg-game-dark min-h-screen">
          ...
          <div className="container mx-auto px-4 py-16 md:py-24 max-w-5xl relative">
            ...
            >
              ...
              <p className="text-game-light/75 text-lg leading-relaxed max-w-2xl mb-8">
                ...
                creative systems, and clear craft. Selected work will appear below.
              </p>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            >
              ...
              <p className="text-game-light/60 text-lg max-w-2xl">
                Projects, games, and experiments. More entries coming soon.
              </p>
            </motion.div>
            ...
            {projects.length > 0 ? (
                ...
                {projects.map((project, index) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-game-light/75 leading-relaxed mb-4">
                        {project.description}
                      </p>
                      {project.link && (
                        <a
              ...
              <motion.div
                ...
                className="border-2 border-dashed border-game-accent/30 rounded-lg p-10 md:p-14 text-center"
              >
                <p className="text-game-light/70 text-lg mb-2">
                  Project entries coming next.
                </p>
                <p className="text-game-light/45 text-sm max-w-md mx-auto">
                  This space is ready for titles, descriptions, tags, images, and
                  links — send your project details when you are ready.
                </p>
              </motion.div>
            )}
          </div>
        ...
        {/* Focus areas — light base section */}
